                ...
                <div class="admin-content"> 
                    ...
                    <div class ="content">
                        ...
                        <div>
                                ...
                                <input type="text" name="name" id="" class="text-input" value="<?php echo $product_ID['product_name']; ?>">
                            </div>
                            <input type="hidden" name="id" value="<?php echo $product_ID['product_ID']; ?>">
                            <div>
                                <label>ราคาสินค้า</label>
                                <input type="number" name="price" class="text-input" min="0" step="0.25" required value="<?php echo $product_ID['product_price'];?>">                            </div>
                            <div>
                                <label>สี</label>
                                <input type="text" name="color" id="" class="text-input" value="<?php echo $product_ID['product_color']; ?>">
                            </div>
                            <div>
                                <label>ขนาด</label>
                                <input type="text" name="size" id="" class="text-input" value="<?php echo $product_ID['product_size']; ?>">
                            </div>

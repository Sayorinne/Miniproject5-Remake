...
$sql = "SELECT rr.repair_id, rr.reservation_date, rr.reservation_time, rr.detail, rst.status_name 
        ...
        WHERE rr.repair_id = ? AND rr.User_ID = ?";
...
$stmt->bind_param("ss", $repair_id, $user_id);
$stmt->execute();
...
$reserveRepair = $result->fetch_assoc();
      ...
      <div class="booking-detail">
        ...
        <div class="detail-card">
          ...
          <div class="detail-row">
            ...
            <span class="value"><?php echo htmlspecialchars($reserveRepair['reservation_date']); ?></span>
          </div>

          <div class="detail-row">
            <span class="label">เวลา : &nbsp;</span>
            <span class="value"><?php echo htmlspecialchars($reserveRepair['reservation_time']); ?></span>
          </div>

          <div class="detail-row">
            <span class="label">เนื้อหา : &nbsp;</span>
            <span class="value"><?php echo htmlspecialchars($reserveRepair['detail']); ?></span>
          </div>
          ...
          <div class="button-group">
            ...
            <?php if ($reserveRepair['status_name'] == 'รอดำเนินการ'): ?>
